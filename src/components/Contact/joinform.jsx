...
const schema = Yup.object().shape({
  ...
  message: Yup.string().max(200, "Should not be more than 200 Characters"),
});
...
const Contact = React.forwardRef((props, ref) => {
  ...
  const SubmitForm = (data, e) => {
    emailjs
      .send("gmail", "gmail_template", e.target, "user_VxY4OJHzwej0Cv5B4mDg9")
      .then(
        (result) => {
  ...
  return (
    <>
      <ContactForm onSubmit={handleSubmit(SubmitForm)} ref={ref}>
        <ContactWrapper>
        ...
        <ContactWrapper>
          ...
          <InputFields type="email" name="email" id="email" ref={register()} />
